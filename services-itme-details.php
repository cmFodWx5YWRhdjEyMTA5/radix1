  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-right"> 
        ...
        <a href="index.php">Home <i class="fa fa-angle-double-right"></i></a> <span>Spa Services</span> 
...
<section id="work-details" class="padding_top">
  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-5 col-sm-5 col-xs-12">
          ...
          <div class="dark-grey jw-animate-gen noOpacity" data-gen="fadeInLeft" data-gen-offset="70%"> 
              ...
              <span><i class="fa fa-calendar"></i><strong>Spa Work Date:</strong> March 2016</span> 

              <span><i class="fa fa-map-marker"></i><strong>Location:</strong> Ibiza, Spain</span> 

              <span><i class="fa fa-expand"></i><strong>Wedding:</strong> 2,540 m2</span> 

              <span><i class="fa fa-user-md"></i><strong>Investor:</strong> Private owner</span> 

              <span><i class="fa fa-usd"></i><strong>Value:</strong> $950,000</span> 

              <span><i class="fa fa-list"></i><strong>Category:</strong> Body Treatments</span> 
      ...
      <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="work-detail">
            ...
            <h1 class="jw-animate-gen noOpacity" data-gen-offset="85%" data-gen="fadeInDown">We offer a wide variety of wellness treatments</h1>

            <div class="jw-animate-gen noOpacity" data-gen-offset="80%" data-gen="fadeInLeft">
              ...
              <ul>
                ...
                <li>Nulla rhoncus lectus convallis, cursus tellus id, maximus ligula. Nulla nec porttitor lectus, et eleifend leo. Cras conval lis diam ut cursus finibus.</li>

                <li>Sed nisi commodo lorem sollicitudin vehicula. Ut fringilla urna id enim dignissim pharetra. Donec sit amet auctor  purus epsum set eut</li>
    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12"> <img src="images/services_details_1.jpg" class="img-responsive" alt="about"> </div>

      <div class="col-md-6 col-sm-6 col-xs-12"> <img src="images/services_details_3.jpg" class="img-responsive" alt="about"> </div>

      <div class="col-md-12 col-sm-12 col-xs-12">

        <div class="work-detail">

          <h1>We offer a wide variety of wellness treatments</h1>
          ...
          <div class="row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> <a href="#" class="red-button  btn-4 btn-4d"> <span>Previous</span> </a> </div>

            <div class="col-md-6 col-sm-6 col-xs-12 text-right"> <a href="#" class="red-button  btn-4 btn-4c" > <span>Next</span> </a> </div>
