...
<section id="form" class="section_space" style="padding: 30px 0;">
					  ...
					  <table data-toggle="table">
                        <thead>
                          <tr>
                            ...
                            <th data-field="contactperson"  data-sortable="true">Package/Service Name</th>
                            <th data-field="contactno" data-sortable="true" >Name</th>
  ...
  $q="select * from confirmbook_package where binaryid like '".$id."-%' order by id asc";
