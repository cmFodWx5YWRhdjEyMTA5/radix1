  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <h4>My Services List</h4>

      </div>

      <div class="col-md-6 text-right"> <a href="index.php">Home <i class="fa fa-angle-double-right"></i></a> <span>My Services List</span> </div> 
...
<section id="form" class="section_space" style="padding: 30px 0;">
  ...
  <h2>My Services Appointments</h2>
<table width="100%" border="1" bordercolor="#eb268f">
  ...
  $q="select * from confirmbook_package where service_type='Service' and package in (select id from Services where sellerid='".$username."') order by id asc";
 ...
 <td><?php echo servicesamount($q3['package']); ?></td>
  <td><?php echo customername($q3['emailid']); ?></td>
  ...
  <tr>
    ...
    <td colspan="6">No Services Appointment Found.</td>
