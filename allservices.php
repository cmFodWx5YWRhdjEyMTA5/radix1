  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-right"> 
        ...
        <a href="index.php">Home <i class="fa fa-angle-double-right"></i></a> <span>Our Services</span> 
...
<section id="our_services" class="section_space">
    ...
    <div class="row">
      ...
      <div class="col-md-12 text-center">
       ...
       <img src="images/heading-icon.png" alt="section heading">
        ...
        <h2>Our Beauty Parlour and Spa Services</h2>
 ...
 <?php
				$q="select * from Services order by Name asc ";
  ...
  $id = base64_encode($q3['id']);
      ...
      <div class="col-md-4 col-sm-4 col-xs-12 wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1900ms">
        ...
        <div class="effect"> 
          ...
          <span class="button-effect"> <a href="serviceslisting.php?id=<?php echo base64_encode($q3['id']);?>" class="red-button  btn-4 btn-4c"> <span>Show List </span> </a> </span> 
