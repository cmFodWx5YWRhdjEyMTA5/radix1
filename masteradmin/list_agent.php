...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
						...
						<table border="1" style="width:100%; border-color:#eb268f;">
                            ...
                            <?php
  $q="select * from agent order by id desc";
  $q1=mysql_query($q);
  ...
  ?>
	    ...
	    <td><?php echo $q3['firstname']; ?></td>
         <td><?php echo $q3['lastname']; ?></td>
          <td><?php echo $q3['email']; ?></td>
         <td><?php echo $q3['mobile']; ?></td>
		   <td><?php echo $q3['active']; ?></td>
	  <td><?php echo $q3['createdby']; ?></td> 
      <td><a href="edit_agent.php?id=<?php echo $id;?>">Edit</a></td>
    <td><a href="delete_agent.php?id=<?php echo $id;?>">Delete</a></td>
                            </tr>
                             <?php
  }
  }
