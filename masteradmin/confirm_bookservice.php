...
$qry="insert into confirmbook_package(emailid,package,packagebooking_date,package_bookingtime,confirm_date,binaryid,service_type) values('".$emailid."','".$package."','".$packagebooking_date."','".$package_bookingtime."','".$date."','".$binaryid."','Service')";
mysql_query($qry);
}

$pquery="delete from book_service where id=$id";
mysql_query($pquery);
