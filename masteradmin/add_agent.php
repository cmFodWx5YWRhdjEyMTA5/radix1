...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<div>
				 <form name="customForm" id="customForm" method="post" action="save_agent.php" enctype="multipart/form-data">
<table width="100%" border="0">
  <tr bgcolor="#fff">
    <th scope="col"><input type="text" id="companyname" name="companyname" placeholder="First Name" class="form-control" autofocus=""></th>
    <th scope="col"><input type="text" id="contactperson" name="contactperson" placeholder="Last Name" class="form-control" /></th>
  </tr>
  <tr bgcolor="#fff">
