...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List City</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List City</h1>
			</div>
		</div><!--/.row-->
  ...
  $q="select * from location order by name asc";
  ...
  ?>
	  ...
	  <td><?php echo $q3['createdby']; ?></td> 
       <td><a href="edit_city.php?id=<?php echo $id;?>">Edit</a></td>
    <td><a href="delete_city.php?id=<?php echo $id;?>">Delete</a></td>
                            </tr>
                             <?php
  }
  }
