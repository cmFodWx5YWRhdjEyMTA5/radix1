...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Confirmed Members</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Confirmed Members</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
						...
						<table border="1" style="width:100%; border-color:#eb268f;">
						    ...
						    <tr>
                                ...
                                <th data-field="name">Gender</th>
                                <th data-field="name">Pincode</th>
                                <th data-field="name">City</th>
                                <th data-field="name">Registration Date</th>
                                <th data-field="name">Confirmation Date</th>
						        
						    </tr>
						    </thead>
                          <?php

  $q="select * from members where confirmation='Yes' order by id desc";
  ...
  ?>
             ...
             <td><?php echo $q3['gender']; ?></td>
		     <td><?php echo $q3['pincode']; ?></td>
	         <td><?php echo $q3['city']; ?></td> 
             <td><?php echo $q3['registration_date']; ?></td>
		     <td><?php echo $q3['confirmation_date']; ?></td>      
                            </tr>
                             <?php
  }
  }
  ...
  {
  ?><tr style="color:#eb268f; background-color: #fff;">
    <td colspan="9">No Confirmed Member Found.</td>
  </tr>
  <?php
  }
  ?>
