...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Confirmed Booked Packages</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Confirmed Booked Packages</h1>
			</div>
		</div><!--/.row-->
  ...
  $q="select * from confirmbook_package where service_type='Package' order by id asc";
