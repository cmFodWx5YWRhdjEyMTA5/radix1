				...
				<div class="panel-body">
					<form role="form" id="slick-login" name="slick-login" action="doLogin.php" method="post">
						<fieldset>
							...
							<div class="form-group">
								<input class="form-control" placeholder="Password" name="password" id="password" type="password" value=""><input value="admin" name="usertype" id="usertype" type="hidden" required class="user form-control"/>
							</div>
