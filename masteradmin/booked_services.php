...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Booked Services</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Booked Services</h1>
			</div>
		</div><!--/.row-->
  ...
  $q="select * from book_service order by id asc";
  ...
  ?>
             ...
             <td><a href="confirm_bookservice.php?id=<?php echo $id;?>">Confirm</a></td>
    <td><a href="notinterest_bookservice.php?id=<?php echo $id;?>">Not Interested</a></td>
