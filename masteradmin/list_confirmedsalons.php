...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Confirmed Salons</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Confirmed Business</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
						...
						<table border="1" style="width:100%; border-color:#eb268f;">
						    ...
						    <tr>
						        ...
						        <th data-field="name">Salon Name</th>
  ...
  $q="select * from listings where confirmation='Yes' order by id desc";
  ...
  ?>
    ...
    <td><?php echo $q3['listing_type']; ?></td>
		     ...
		     <td><?php echo $q3['confirmation_date']; ?></td>
              <td><a href="edit_listing.php?id=<?php echo $id;?>">Edit</a></td>

    <td><a href="delete_listing.php?id=<?php echo $id;?>">Delete</a></td>      
                            </tr>
                             <?php
  }
  }
  ...
  {
  ?><tr style="color:#eb268f; background-color: #fff;">
    <td colspan="10">No Confirmed Member Found.</td>
  </tr>
  <?php
  }
  ?>
