...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Not Confirmed Members</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Not Confirmed Members</h1>
			</div>
		</div><!--/.row-->
  ...
  $q="select * from members where confirmation='No' order by id desc";
  ...
  {
  ?><tr style="color:#eb268f; background-color: #fff;">
    <td colspan="8">No Not Confirmed Member Found.</td>
  </tr>
  <?php
  }
  ?>
