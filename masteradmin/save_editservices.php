...
$qry="select * from Services where id='".$id."'";
	...
	$q="select * from Services where Name='".trim($_POST['category'])."' && Name!='".$qry4."'";
	$q1=mysql_query($q);
	...
	if($qry4 == trim($_POST['category']) && $fp != '')
	{
	$qry="update Services set image='".$fp."' where id='".$id."'";
	mysql_query($qry);
	die("Saved!");
	}
	if($q2 > 0)
	...
	if($fp == '')
	{
	$qry="update Services set Name='".trim($_POST['category'])."' where id='".$id."'";
	mysql_query($qry);
	die("Saved!");
	}
	else
	{
	$qry="update Services set Name='".trim($_POST['category'])."',image='".$fp."' where id='".$id."'";
	mysql_query($qry);
	die("Saved!");
	}
	}
