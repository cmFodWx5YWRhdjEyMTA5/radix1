...
window.location.href='list_city.php';
...
<body>
  ...
  ?>
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<form name="customForm" id="customForm" method="post" action="save_editcity.php">


<input type="hidden" name="id" id="id" value="<?php echo $id;?>" />
<input type="text" id="city" name="city" placeholder="City" class="form-control" value="<?php echo $q3['name'];?>">
<br>
