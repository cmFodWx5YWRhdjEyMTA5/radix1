...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Not Confirmed Salons</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Not Confirmed Business</h1>
			</div>
		</div><!--/.row-->
  ...
  $q="select * from listings where confirmation='No' order by id desc";
  ...
  {
  ?><tr style="color:#eb268f; background-color: #fff;">
    <td colspan="9">No Not Confirmed Salon Found.</td>
  </tr>
  <?php
  }
  ?>
