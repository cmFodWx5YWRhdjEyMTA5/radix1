...
<input type="text" id="emailid" name="emailid" value="<?php echo $q2['emailid']; ?>" placeholder="Email ID" class="form-control">
...
<ul style="list-style:none;">
			...
			<li>
				...
				<input class="checkbox" type="checkbox" name="cb_modes[]" id="cb_modes[]" value="Money Orders" <?php if($payment_mode== in_array('Money Orders', $payment_mode)) echo 'checked="checked"'?>>
        ...
        <br />
        <select id="active" name="active" style="width:192px;padding:8px;border:1px solid #ccc;border-radius:4px; font-family: Segoe UI Light; font-size:14px;">
