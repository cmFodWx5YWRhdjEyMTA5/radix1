...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Booked Packages</li>
			</ol>
		</div><!--/.row-->
		
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">List Booked Packages</h1>
			</div>
		</div><!--/.row-->
		...
		<div class="row">
						...
						<table border="1" style="width:100%; border-color:#eb268f;">
						    ...
						    <tr>
                                ...
                                <th data-field="name">Confirm</th>
                                <th data-field="name">Not Interested</th>
						        
						    </tr>
						    </thead>
                          <?php

  $q="select * from book_package order by id asc";
  ...
  ?>
             ...
             <td><a href="confirm_bookpackage.php?id=<?php echo $id;?>">Confirm</a></td>
    <td><a href="notinterest_bookpackage.php?id=<?php echo $id;?>">Not Interested</a></td>
