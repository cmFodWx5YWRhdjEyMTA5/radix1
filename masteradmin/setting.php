	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			...
			<div class="col-xs-12 col-md-6 col-lg-3">
				<form name="customForm" id="customForm" method="post" action="save_changepassword.php">


<input type="hidden" name="id" id="id" value="<?php echo $username;?>" />
<input type="password" id="city" name="city" placeholder="Enter New Password" class="form-control">
<br>
<input type="password" id="city1" name="city1" placeholder="Enter Again New Password" class="form-control">
<br>
