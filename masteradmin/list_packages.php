...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">List Packages</li>
			</ol>
		</div><!--/.row-->
  ...
  ?>
	    ...
	    <td><?php echo $q3['Name']; ?></td>
         <td><?php echo $q3['type']; ?></td>
		   <td><?php echo $q3['active']; ?></td>
	  <td><?php echo $q3['createdby']; ?></td> 
      <td><a href="edit_packages.php?id=<?php echo $id;?>">Edit</a></td>
    <td><a href="delete_packages.php?id=<?php echo $id;?>">Delete</a></td>
                            </tr>
                             <?php
  }
  }
