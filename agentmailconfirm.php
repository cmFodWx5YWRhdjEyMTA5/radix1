...
$date = date("Y-m-d");
$q="select * from agent where confirmation_code='".$id."'";
$q1=mysql_query($q);
$q2=mysql_num_rows($q1);
if($q2>0)
{
$qry="update agent set confirmation='Yes',confirmation_date='".$date."' where confirmation_code='".$id."'";
mysql_query($qry);
$msg='Thanks! for be a Agent of Radix Beauty. Your email has been confirmed, Please login to your Agent account. Please <a href="http://radixbeauty.com/agent">click Here</a> to Login';
}
else
{
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <h4>Agent Registration Confirmation</h4>

      </div>

      <div class="col-md-6 text-right"> <a href="index.php">Home <i class="fa fa-angle-double-right"></i></a> <span>Agent Registration Confirmation</span> </div> 
