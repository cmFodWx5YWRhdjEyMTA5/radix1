...
function bookedat($a)
{
$q="select sellerid from Packages where id='".$a."'";
$q1=mysql_query($q);
while($q2=mysql_fetch_array($q1))
{
...
<section id="form" class="section_space" style="padding: 30px 0;">
					  ...
					  <table data-toggle="table">
                        <thead>
                          <tr>
                            ...
                            <th data-field="contactperson"  data-sortable="true">Package Name</th>
                            <th data-field="contactno" data-sortable="true" >Amount</th>
                            <th data-field="category" data-sortable="true">Booked At</th>
                            <th data-field="registrationdate"  data-sortable="true">View Details</th>
 ...
 $q="select * from confirmbook_package where emailid='".$username."' and service_type='Package' order by id asc";
  ...
  ?>
                          <tr data-index="<?php echo $count;?>">
                            ...
                            <td style=""><a href="manage_appointments.php?id=<?php echo $id;?>">View Details</a></td>
