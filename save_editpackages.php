...
$sellerid = base64_decode($_POST['id']);
 ...
 $qry="select * from Packages where id='".$sellerid."' && sellerid='".$username."'";
	...
	$q="select * from Packages where Name='".trim($_POST['category'])."' && Name!='".$qry4."' && sellerid='".$username."'";
	$q1=mysql_query($q);
	...
	{
	$qry="update Packages set Name='".trim($_POST['category'])."',description='".trim($_POST['desc'])."',price='".trim($_POST['price'])."' where id='".$sellerid."'";
		mysql_query($qry);
	die("Saved!");
	}
