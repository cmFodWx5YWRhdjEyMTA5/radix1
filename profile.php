...
<body>
 ...
 $id = base64_encode($q2['id']);
  ...
  ?>
				...
				<form name="customForm" id="customForm" method="post" action="update_profile.php" enctype="multipart/form-data">
...
<table width="100%" border="0">
  ...
  <tr>
    ...
    <th scope="col"><input type="text" id="emailid" name="emailid" value="<?php echo $q2['email']; ?>" placeholder="Email ID" class="form-control" readonly></th>
  </tr>
  <tr>
