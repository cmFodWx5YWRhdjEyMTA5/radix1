...
<section id="page-heading">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-right"> <a href="index.php">Home <i class="fa fa-angle-double-right"></i></a> <span>Add Package</span> </div> 
...
<section id="form" class="section_space" style="padding: 10px 0;">
  ...
  <div class="container">
     ...
     <h2>Add Package</h2>
				...
				<form name="addpackagecustomForm" id="addpackagecustomForm" method="post" action="save_packages.php" enctype="multipart/form-data">
