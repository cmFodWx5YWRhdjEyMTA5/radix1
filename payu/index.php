...
<table>
	...
	<tr><td>success url</td><td><input type="text" name="surl" value="http://radixbeauty.com/payu/success.php" size="64" /></td></tr>
	<tr><td>failure url</td><td><input type="text" name="furl" value="http://radixbeauty.com/payu/fail.php" size="64" /></td></tr>
