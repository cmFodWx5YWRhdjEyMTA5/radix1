...
*/
	if($_POST['companyname'] != '' and $_POST['city'] != '' and $_POST['pincode'] != '' and $_POST['area'] != '' and $_POST['landmark'] != '' and $_POST['building'] != '' and $_POST['street'] != '' and $_POST['contactperson'] != '' and $_POST['contactno'] != '' and $_POST['emailid'] != '' and $q2 < 1)

	{
	$random = rand();

	$qry="insert into listings(companyname,contactperson,contactno,emailid,password,building,street,landmark,area,pincode,city,listing_type,creationdate,country,active,createdby,cat_id,description,website,confirmation_code,confirmation) values('".trim($_POST['companyname'])."','".trim($_POST['contactperson'])."','".trim($_POST['contactno'])."','".trim($_POST['emailid'])."','".trim($_POST['password'])."','".trim($_POST['building'])."','".trim($_POST['street'])."','".trim($_POST['landmark'])."','".trim($_POST['area'])."','".trim($_POST['pincode'])."','".trim($_POST['city'])."','Free','".$date."','India','No','".$username."','".trim($_POST['cat'])."','".trim($_POST['desc'])."','".trim($_POST['website'])."','".$random."','No')";
