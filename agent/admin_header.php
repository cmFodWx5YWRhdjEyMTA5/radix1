			...
			<div class="navbar-header">
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
                        ...
                        $q=mysql_query("select firstname from agent where email='".$username."'");
						$q1=mysql_fetch_assoc($q);
						echo $q1['firstname'];
						?> <span class="caret"></span></a>
						<ul class="dropdown-menu" role="menu">
							
							<li><a href="listing.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Listings</a></li>
                            <li><a href="profile.php"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg> Settings</a></li>
