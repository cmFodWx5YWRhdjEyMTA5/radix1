...
<section id="page-heading">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-6 text-right"> <a href="index.php">Home <i class="fa fa-angle-double-right"></i></a> <span>Edit Package</span> </div> 
...
<section id="form" class="section_space" style="padding: 10px 0;">
  ...
  ?>
				...
				<form name="addpackagecustomForm" id="addpackagecustomForm" method="post" action="save_editpackages.php" enctype="multipart/form-data">

<input type="text" id="category" name="category" placeholder="Package" class="form-control" value="<?php echo $q3['Name'];?>">
