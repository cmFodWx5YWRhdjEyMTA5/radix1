...
<table width="100%" border="1" bordercolor="#eb268f">
  ...
  $q="select * from confirmbook_package where emailid='".$username."' order by id asc";
  ...
  <td><?php echo $q3['packagebooking_time']; ?></td>
 <td><?php echo packagesname($q3['package']); ?></td>
  <td><a href="manage_appointments.php?id=<?php echo base64_encode($q3['package']);?>">View Details</a></td>
  <!--<td><a href="mydownline.php?id=<?php //echo base64_encode($q3['binaryid']);?>">View Downline</a></td>-->
   <td><a href="mygeonology.php?id=<?php echo base64_encode($q3['binaryid']);?>">View Geonology</a></td>
  ...
  <tr>
    ...
    <td colspan="6">No Package AppointmentFound.</td>
